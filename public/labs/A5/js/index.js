...
const notFound = numberArray1.find(a => a === 25);
console.log(four);
console.log(string3);
console.log('What happens when we cant find the target?', notFound);
console.log('\n')
